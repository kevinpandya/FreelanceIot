...
public class WordStats {
     ...
     */
    public CompletionStage<LinkedHashMap<String, Resultlist>> getResult(List<String> desc) {
        return CompletableFuture.supplyAsync(()-> this.getWordStats(desc));
    }
     ...
     */
    public LinkedHashMap<String, Resultlist> getWordStats(List<String> desc) {
        String searchPhrase = "";
