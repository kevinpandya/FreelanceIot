...
public class SearchProfile {
    ...
    public LinkedHashMap<String, Profile> getProfileResult(String id) {
        ...
        try {
            URL url = new URL("https://www.freelancer.com/api/users/0.1/portfolios/?limit=10&compact=true&portfolio_details=true&user_details=true&user_qualification_details=true&user_jobs=true&user_portfolio_details=true&user_recommendations=true&count=true&user_profile_description=true&users[]=" + id);
