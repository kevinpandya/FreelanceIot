...
package controllers.javascript {
  ...
  class ReverseHomeController(_prefix: => String) {
    ...
    def wordStat: JavaScriptReverseRoute = JavaScriptReverseRoute(
      ...
      """
        function(search0) {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "stat/" + encodeURIComponent((""" + implicitly[play.api.mvc.PathBindable[String]].javascriptUnbind + """)("search", search0))})
        }
      """
    )
    ...
    def skill: JavaScriptReverseRoute = JavaScriptReverseRoute(
      ...
      """
        function(id0) {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "skill/" + encodeURIComponent((""" + implicitly[play.api.mvc.PathBindable[String]].javascriptUnbind + """)("id", id0))})
        }
      """
    )
